...
public class ActivityMainCrud extends AppCompatActivity {
    ...
    private void readData() {
        ...
        myDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                while ((iterator.hasNext())) {
                    ...
                    ((CustomListAdapter) (((ListView) findViewById(R.id.peopleList)).getAdapter())).notifyDataSetChanged();
                }
            }
        ...
        ((ListView) findViewById(R.id.peopleList)).
                setAdapter(new CustomListAdapter(names, phoneNumbers, this));
