package com.path.googlemaps.AnimateMovingMarker;
...
public class MarkerActivity extends AppCompatActivity implements LocationUtil.GetLocationListener {
            ...
            public void onMapReady(GoogleMap googleMap) {
                if (googleMap != null) {
                    ...
                    if (ActivityCompat.checkSelfPermission(MarkerActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) !=
                            PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(MarkerActivity.this,
    ...
    public void updateLocation(Location location) {
        ...
        if (marker == null) {
            ...
            Picasso.with(MarkerActivity.this).load(R.drawable.car).resize(50, 50)
                    .into(marker);
